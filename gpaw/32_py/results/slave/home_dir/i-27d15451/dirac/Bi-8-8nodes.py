...
def energy(k, h, dl, da, dh, vac, var, num):
    slab = Atoms([Atom('Bi', (0.0000, 0.0000,      -dl)),
                  ...
                  Atom('Bi', (3*da/2, sqrt*da/2,   -dl*2-dh*2)),
                  Atom('Bi', (da,     sqrt*da/3,   -dl*3-dh*2)),
                  Atom('Bi', (2*da,   sqrt*da,     -dl*2-dh*2)),
                  Atom('Bi', (5*da/2, 5*sqrt*da/6, -dl*3-dh*2)),
                  Atom('Bi', (5*da/2, sqrt*da/2,   -dl*2-dh*2)),
                  Atom('Bi', (2*da,   sqrt*da/3,   -dl*3-dh*2)),
                  Atom('Bi', (3*da,   sqrt*da,     -dl*2-dh*2)),
                  Atom('Bi', (3*da/2, 5*sqrt*da/6, -dl*3-dh*2)),
                  Atom('Bi', (3*da/2, sqrt*da/2,   -dl*4-dh*3)),
                  Atom('Bi', (da/2,   sqrt*da/6,   -dl*3-dh*3)),
                  Atom('Bi', (2*da,   sqrt*da,     -dl*4-dh*3)),
                  Atom('Bi', (2*da,   2*sqrt*da/3, -dl*3-dh*3)),
                  Atom('Bi', (5*da/2, sqrt*da/2,   -dl*4-dh*3)),
                  Atom('Bi', (3*da/2, sqrt*da/6,   -dl*3-dh*3)),
                  Atom('Bi', (3*da,   sqrt*da,     -dl*4-dh*3)),
                  Atom('Bi', (da,     2*sqrt*da/3, -dl*3-dh*3)),],
