...
def main(argv=None):
    ...
    Total cores = 8
    Total memory = 30GB
    HPCC N = sqrt((30000000000 / 8)* .8 = 54772
    '''
    ...
    startCmd = "mpirun -np %d hpcc %s > experiment.out 2>&1; date > %s" % (numCores, "/home/hpcc-user/hpccinf.txt", doneFile)
    

    instanceType = InstanceType("m2.xlarge", 4, 7500, 1500, [])
    ...
    deployment = Deployment("cloud_hpcc", 
                            ...
                            roles=[
                                   Role(masterRole, "master", 
                                        ...
                                        dataCollectors=[DataCollector(source="/home/hpcc-user/hpccoutf.txt", 
                                                                      destination=masterOutDir + "hpccout.txt",
                                                                      sshCred=sshCred),
